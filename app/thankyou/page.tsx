      ...
      <section id="thankyou" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="thankyou-content text-center max-w-2xl mx-auto">
            ...
            Thank you for choosing Platinum Window Experts! Your request has been received and a roofing specialist will contact you soon to schedule your free estimate.
            </p>
