...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const redirectUrl = `${process.env.NEXT_PUBLIC_BASE_URL || 'https://platinumwindowexperts.com'}/thankyou?email=${encodeURIComponent(email)}${buyer ? `&buyer=${encodeURIComponent(buyer)}` : ''}`
